  ...
  return (
    <div className="h-full min-h-[72vh]">
      <section className="relative h-full min-h-[72vh] overflow-hidden rounded-[30px] border border-white/10 bg-[linear-gradient(180deg,rgba(2,6,23,0.62),rgba(2,6,23,0.82))] shadow-[0_26px_70px_rgba(2,6,23,0.34)] lg:min-h-[calc(100vh-3.5rem)]">
        ...
        <div className="pointer-events-none absolute inset-x-3 top-3 z-20 lg:left-4 lg:right-[344px] lg:top-4">
          <div className="pointer-events-auto">{header}</div>
        </div>

        <div className="pointer-events-none absolute inset-x-3 bottom-16 z-20 lg:bottom-16 lg:left-4 lg:right-[344px]">
          <div className="pointer-events-auto">{shelf}</div>
        </div>

        <div className="pointer-events-none absolute inset-x-3 bottom-3 z-20 lg:left-4 lg:right-[344px]">
        ...
        <div className="pointer-events-none absolute inset-x-3 bottom-[13.5rem] z-20 sm:max-w-[320px] lg:hidden">
          <div className="pointer-events-auto">{inspector}</div>
        </div>
      </section>
    </div>
