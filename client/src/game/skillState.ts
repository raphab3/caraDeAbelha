...
export function normalizePlayerProgressState(playerProgress: PlayerProgressState): PlayerProgressState {
  ...
  return {
    ...
    currentEnergy: typeof playerProgress.currentEnergy === "number" ? playerProgress.currentEnergy : 100,
    maxEnergy: typeof playerProgress.maxEnergy === "number" ? playerProgress.maxEnergy : 100,
